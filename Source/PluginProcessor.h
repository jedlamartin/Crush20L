...
public:
    ParameterAttachment(Stage* stageToListenTo,
                        juce::AudioProcessor* processor) :
        stageToListenTo(stageToListenTo), processor(processor) {};
};
...
private:
    ...
    Stage5 stage5;
    Stage6 stage6;
    ParameterAttachment stage2Attachment, stage3Attachment, stage4Attachment,
        stage5Attachment;
